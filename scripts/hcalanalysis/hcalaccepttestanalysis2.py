...
comp_e_barrel = HistComparator(tree, style1 = cms_style, style2 = papas_style,
                      ...
                      var1 = 'cmsjet_e', 
                      cut1 = 'gen_jet_pt>0 && abs(gen_jet_eta)<1.3 && simtrack_len==1 && cmsjet_22_e/cmsjet_e<0.1 && gen_jet_e>1 && gen_jet_e<100',
                      var2 = 'papasjet_e',
                        cut2 = 'gen_jet_pt>0 && abs(gen_jet_eta)<1.3 && simtrack_len==1 && papasjet_22_e/papasjet_e<0.1 && gen_jet_e>1 && gen_jet_e<100')

comp_pt_barrel = HistComparator(tree, style1 = cms_style, style2 = papas_style,
                      nbin = 100, xmin = 0, xmax = 5, xvar = 'Pt_{rec} (GeV)',
                      var1 = 'cmsjet_pt', 
                      cut1 = 'gen_jet_pt>0 && abs(gen_jet_eta)<1.3 && simtrack_len==1 && cmsjet_22_e/cmsjet_e<0.1 && gen_jet_e>1 && gen_jet_e<100',
                      var2 = 'papasjet_pt',
                        cut2 = 'gen_jet_pt>0 && abs(gen_jet_eta)<1.3 && simtrack_len==1 && papasjet_22_e/papasjet_e<0.1 && gen_jet_e>1 && gen_jet_e<100')
...
comp_e_endcap = HistComparator(tree, style1 = cms_style, style2 = papas_style,
                      nbin = 100, xmin = 0, xmax = 5, xvar = 'E_{rec} (GeV)',
                      var1 = 'cmsjet_e', 
                      cut1 = 'gen_jet_pt>0 && abs(gen_jet_eta)>1.3 && abs(gen_jet_eta)<2.93 && simtrack_len==1 && cmsjet_22_e/cmsjet_e<0.1 && gen_jet_e>1 && gen_jet_e<100',
                      var2 = 'papasjet_e',
                        cut2 = 'gen_jet_pt>0 && abs(gen_jet_eta)>1.3 && abs(gen_jet_eta)<2.93 && simtrack_len==1 && papasjet_22_e/papasjet_e<0.1 && gen_jet_e>1 && gen_jet_e<100')
...
# comp_eta_endcap_low_pt = HistComparator(tree, style1 = cms_style, style2 = papas_style,
#                       nbin = 100, xmin = 0, xmax = 4, xvar = 'P_{Trec} (GeV)',
#                       var1 = 'cmsjet_eta', 
#                       cut1 = 'gen_jet_pt>0 && abs(gen_jet_eta)>1.3 && abs(gen_jet_eta)<2.93 && simtrack_len==1 && cmsjet_22_e/cmsjet_e<0.1 && gen_jet_e>1 && gen_jet_e<100 && cmsjet_e>3',
#                       var2 = 'papasjet_eta',
#                         cut2 = 'gen_jet_pt>0 && abs(gen_jet_eta)<1.3 && simtrack_len==1 && papasjet_22_e/papasjet_e<0.1 && gen_jet_e>1 && gen_jet_e<100 && papasjet_e>3')
