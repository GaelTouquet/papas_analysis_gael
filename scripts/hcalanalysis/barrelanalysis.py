...
comp = HistComparator(tree, style1 = cms_style, style2 = papas_style,
                      ...
                      cut = 'gen_jet_pt>10 && gen_jet_e<100 && abs(gen_jet_eta)<1.3 && simtrack_len==1 && cmsjet_22_e/cmsjet_e<0.01')

fitter = Fitter2D('histo2d','E_{rec}/E_{gen}vsE_{gen} barrel', 100, 0, 100, 200, 0, 2)
tree.Project('histo2d','cmsjet_e/gen_jet_e:gen_jet_e','gen_jet_e>1 && gen_jet_e<100 && abs(gen_jet_eta)<1.3 && simtrack_len==1 && cmsjet_22_e/cmsjet_e<0.01')
fitter.fit_slices()
can1 = TCanvas()
fitter.h2d.Draw()
