...
tree.Project('e_cms','cmsjet_e', 'gen_jet_pt>0 && abs(gen_jet_eta)<1.3 && simtrack_len==1')
e_cms.Sumw2()
e_papas = TH1F('e_papas', 'Papas energy', 200, 0, 50)
tree.Project('e_papas','papasjet_e', 'gen_jet_pt>0 && abs(gen_jet_eta)<1.3 && simtrack_len==1')
e_papas.Sumw2()
